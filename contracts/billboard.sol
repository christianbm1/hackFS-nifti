...
contract BillboardFactory is ERC721URIStorage, ContextMixin, Ownable  {
    ...
    function assignBillBoardSpace(address recipient, string memory tokenURI) public returns (uint256){
        ...
        uint256 newItemId = _billboardIds.current();
    ...
    function transferBillboard(address from, address to, uint256 tokenId) public {
